            ...
            {EXTRUSION_LINES.map((line) => {
              ...
              return (
                <div
                  ...
                  className={`px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-xl border text-left flex items-center justify-between gap-2 transition-all cursor-pointer select-none shrink-0 ${
                    isDragging
