...
export const PLANTS = [
  {
    ...
    workers: [
      { id: "sam_mj", name: "이명재", title: "이사", plant: "삼랑진공장", role: "OPERATOR", avatar: "이", pin: "1234" },
      { id: "sam_yc", name: "설유철", title: "책임", plant: "삼랑진공장", role: "OPERATOR", avatar: "설", pin: "1234" },
      { id: "sam_ks", name: "윤경수", title: "책임", plant: "삼랑진공장", role: "OPERATOR", avatar: "윤", pin: "1234" },
      { id: "sam_cy", name: "이창엽", title: "책임", plant: "삼랑진공장", role: "OPERATOR", avatar: "이", pin: "1234" },
      { id: "sam_in", name: "양인나", title: "선임", plant: "삼랑진공장", role: "OPERATOR", avatar: "양", pin: "1234" },
      { id: "sam_ij", name: "조인주", title: "선임", plant: "삼랑진공장", role: "OPERATOR", avatar: "조", pin: "1234" }
    ]
  },
  {
    id: "hallim",
    ...
    workers: [
      { id: "hal_dw", name: "김동욱", title: "책임", plant: "한림공장", role: "OPERATOR", avatar: "김", pin: "1234" },
      { id: "hal_cy", name: "우창용", title: "선임", plant: "한림공장", role: "OPERATOR", avatar: "우", pin: "1234" },
      { id: "hal_sm", name: "오상민", title: "선임", plant: "한림공장", role: "OPERATOR", avatar: "오", pin: "1234" }
    ]
  }
];
